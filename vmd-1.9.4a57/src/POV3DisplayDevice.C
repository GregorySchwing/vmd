 ...
 *      $Revision: 1.129 $        $Date: 2020/07/01 06:09:05 $
 *
 ***************************************************************************/
/**
 *  \file POV3DisplayDevice.C
 *  \brief FileRenderer subclass to export molecular graphics to POV v3.5+.
 */
...
// Draw a triangle mesh as a mesh2 POV-Ray object
void POV3DisplayDevice::trimesh_c4u_n3b_v3f(unsigned char *c, signed char *n,
