 ...
 *	$Revision: 1.84 $	$Date: 2020/02/26 06:00:57 $
 *
 ***************************************************************************/
/**
 *  \file OpenGLExtensions.C
 *  \brief Hardware query and runtime management of OpenGL API extension
 *  function pointers used within OpenGLRenderer and OpenGLShader classes.
 */
