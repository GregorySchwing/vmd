 ...
 *      $Revision: 1.46 $      $Date: 2020/02/26 20:16:56 $
 *
 ***************************************************************************/
/**
 * \file CUDAVolCPotential.cu
 * \brief CUDA accelerated coulombic potential grid calculation.
 *
 ...
 *  David J. Hardy, Leonardo G. Trabuco, and Klaus Schulten.
