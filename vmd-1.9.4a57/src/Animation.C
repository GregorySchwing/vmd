 ...
 *	$Revision: 1.59 $	$Date: 2020/02/26 03:51:30 $
 *
 ***************************************************************************/
/**
 *  \file Animation.C
 *  \brief The Animation class stores pointers to Timestep objects
 *  that contain atomic coordinates and related time-varying data.
 */
