 ...
 *	$Revision: 1.130 $	$Date: 2021/05/14 22:51:35 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
...
protected:
  ...
  /// draw a cylinder array
  virtual void cylinder_array(int num, int res, int caps,
  ...
  /// triangle mesh built from a vertex array
  virtual void trimesh_c4u_n3b_v3f(unsigned char *c, signed char *n, float *v, 
                                   int numfacets) { 
    int i, j;
