 ...
 *	$Revision: 1.29 $	$Date: 2021/08/24 16:49:04 $
 *
 ***************************************************************************/
/**
 * \file OpenGLPbufferDisplayDevice.C
 * \brief OpenGLRenderer subclass adding off-screen framebuffer 
 *        and GLX- or EGL-based OpenGL context management.
 *
 * OpenGL GLX Pbuffers require a windowing system display connection, 
 * but do not require creation of any visible on-screen windows.
 * EGL-based Pbuffers eliminate the need for a windowing system connection
 * and operate with minimum intermediary software.
 */
