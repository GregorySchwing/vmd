 ...
 *      $Revision: 1.28 $      $Date: 2020/02/26 20:16:56 $
 *
 ***************************************************************************/
/**
 * \file CUDAMeasureRDF.cu
 * \brief CUDA kernels for calculating radial distribution function histograms.
 *
 * This work is described in the following paper:
 *
 *  "Fast Analysis of Molecular Dynamics Trajectories with 
 *   Graphics Processing Units - Radial Distribution Function Histogramming"
