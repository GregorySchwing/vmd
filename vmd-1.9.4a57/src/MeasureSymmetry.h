 ...
 *	$Revision: 1.34 $	$Date: 2020/10/28 17:42:35 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
public:
  ...
  int numplanes()     { return int(planes.num()); }

  /// Get total number of rotation axes
  int numaxes()       { return int(axes.num()); }

  /// Get number of equivalent primary axes
  int numprimaryaxes();

  /// Get total number of rotary reflection axes
  int numrotreflect() { return int(rotreflections.num()); }
