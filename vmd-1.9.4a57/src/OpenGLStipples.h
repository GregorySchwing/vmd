 ...
 *      $Revision: 1.13 $       $Date: 2020/02/26 03:51:31 $
 *
 ***************************************************************************/
/**
 *  \file OpenGLStipples.h
 *  \brief Hard-coded tables of polygon stipple patterns used for 
 *  "screen door" transparency (old graphics hardware).
 * 
