 ...
 *	$Revision: 1.151 $	$Date: 2020/10/28 15:09:56 $
 *
 ***************************************************************************/
/**
 *  \file BaseMolecule.h
 ...
 *  It does NOT contain the Timestep array; that is maintained by 
...
/// find the structure (backbone, residues, etc).
/// It does NOT contain the animation list; that is maintained by 
...
public:
  ...
  int num_angles() { return int(angles.num() / 3); }
  ...
  int num_dihedrals() { return int(dihedrals.num() / 4); }
  ...
  int num_impropers() { return int(impropers.num() / 4); }
  ...
  int num_cterms() { return int(cterms.num() / 8); }
  ...
  int num_instances(void) { return int(instances.num()); }
