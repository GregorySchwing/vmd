 ...
 *	$Revision: 1.90 $	$Date: 2020/02/24 18:23:52 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
...
#define QMDATA_BUFSIZ              81 ///< max chars in string data
#define QMDATA_BUFSTRFMT      "%.80s" ///< printf format string to match
#define QMDATA_BIGBUFSIZ         8192 ///< max chars in runtitle string data
#define QMDATA_BIGBUFSTRFMT "%.8191s" ///< printf format string to match
...
class QMData {
 ...
 private:
  ...
  // cases they are just printed for the last step at the end of a calculation. 
...
public:
  ...
  /// Initialize table of normalization factors containing different 
  /// factors for each shell and its cartesian functions.
