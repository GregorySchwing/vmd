 ...
 *	$Revision: 1.76 $	$Date: 2021/10/25 18:13:40 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
...
void Axes::create_cmdlist(void) {
  ...
  txt.putdata(xText, "x", 1.0f, 1.0f, 0, 0, cmdList);
  txt.putdata(yText, "y", 1.0f, 1.0f, 0, 0, cmdList);
  txt.putdata(zText, "z", 1.0f, 1.0f, 0, 0, cmdList);

  // put in commands to draw pickpoints at axes endpoints
  ResizeArray<float> pickpointcoords;
  ResizeArray<int> pickpointindices;
  pickpointcoords.append3(origin);
  pickpointindices.append(0);
  pickpointcoords.append3(xLine);
  pickpointindices.append(1);
  pickpointcoords.append3(xLineCap);
  pickpointindices.append(2);
  pickpointcoords.append3(yLine);
  pickpointindices.append(3);
  pickpointcoords.append3(yLineCap);
  pickpointindices.append(4);
  pickpointcoords.append3(zLine);
  pickpointindices.append(5);
  pickpointcoords.append3(zLineCap);
  pickpointindices.append(6);
