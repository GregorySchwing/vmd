 ...
 *      $Revision: 1.141 $       $Date: 2020/10/28 17:42:35 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
public:
  ...
  void set_values(AtomRep *rep) {
    int sftype = int(rep->get_data(AtomRep::LINETHICKNESS));
...
public:
  ...
  void dataset_append(const char *nm, double newmin, double newmax) {
    ...
    dataset->value(int(minmaxlist.num())-1);
...
public:
  ...
  void dataset_append(const char *nm, double newmin, double newmax) {
    ...
    minmaxlist.append(minmax(newmin, newmax));
    orbitalindex->value(int(minmaxlist.num())-1);
    do_dataset_append(nm, newmin, newmax);
