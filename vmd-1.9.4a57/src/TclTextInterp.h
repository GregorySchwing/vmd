 ...
 *      $Revision: 1.50 $      $Date: 2020/05/22 15:35:45 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
private:
  ...
  int callLevel;
  int gotPartial;
  int uselinenoise;        ///< linenoise console editing activation flag
  int usetecla;            ///< tecla console editing activiation flag
  int needPrompt;
  int ignorestdin;         ///< flag to avoid checking stdin for command input
  ResizeArray<char *> completion_list; ///< line editor cmd completion strings
  VMDApp *app;
