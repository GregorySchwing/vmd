 ...
 *	$Revision: 1.131 $	$Date: 2021/12/21 23:20:58 $
 *
 ***************************************************************************/
/**
 * \file Win32OpenGLDisplayDevice.C
 * \brief OpenGLRenderer subclass managing Win32/Win64 window and input state,
 *        OpenGL WGL context, and framebuffer management.
 *
