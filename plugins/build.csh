...
#    setenv NETCDFLIB -L/autofs/na3_home1/stonej1/vmd/lib/netcdf
 ...
 case login1:
 case crest-login1*:
    echo "Using build settings for ORNL Summit IBM POWER9"
...
#    setenv NETCDFLIB -L/autofs/na3_home1/stonej1/vmd/lib/netcdf
 ...
 case wombat-login*:
    echo "Using build settings for ORNL Wombat ARM64"
    setenv TCLINC -I/ccsopen/home/stonej1/vmd/lib/tcl/include
    setenv TCLLIB -L/ccsopen/home/stonej1/vmd/lib/tcl
    cd $unixdir; make LINUXARM64 TCLINC=$TCLINC TCLLIB=$TCLLIB/lib_LINUXARM64 >& log.LINUXARM64.$DATE < /dev/null &
#    setenv NETCDFINC -I/ccsopen/stonej1/vmd/lib/netcdf/include
#    setenv NETCDFLIB -L/ccsopen/stonej1/vmd/lib/netcdf
    echo "Waiting for all plugin make jobs to complete..."
    wait;
    echo "^G^G^G^G"
    echo "Plugin builds done..."
...
#    setenv HDFLDFLAGS "-lhdf5 -lhdf5_hl"
     ...
     setenv NETCDFINC -I/Users/johns/vmd/lib/netcdf/include
     setenv NETCDFLIB -L/Users/johns/vmd/lib/netcdf/lib_MACOSXARM64
     setenv NETCDFLDFLAGS "-lnetcdf" 
     setenv NETCDFDYNAMIC 1
...
#    setenv HDFLDFLAGS "-lhdf5 -lhdf5_hl"
     ...
     setenv NETCDFINC -I/Users/johns/vmd/lib/netcdf/include
     setenv NETCDFLIB -L/Users/johns/vmd/lib/netcdf/lib_MACOSXX86_64
     setenv NETCDFLDFLAGS "-lnetcdf" 
     setenv NETCDFDYNAMIC 1
...
#     gmake MACOSXX86_64 EXPATDYNAMIC=1 EXPATINC=-I/usr/include EXPATLIB=-L/usr/lib EXPATLDFLAGS=-lexpat SQLITEDYNAMIC=1 SQLITEINC=$SQLITEINC SQLITELIB=$SQLITELIB/lib_MACOSXX86_64 SQLITELDFLAGS=-lsqlite3 TCLINC=-I/Projects/vmd/vmd/lib/tcl/lib_MACOSXX86_64/Tcl.framework/Headers TCLLIB=$TCLLIB/lib_MACOSXX86_64 >& log.MACOSXX86_64.$DATE
    gmake MACOSXX86_64 TCLINC=-I/Users/johns/vmd/lib/tcl/lib_MACOSXX86_64/Tcl.framework/Headers TCLLIB=$TCLLIB/lib_MACOSXX86_64 >& log.MACOSXX86_64.$DATE
    breaksw;
